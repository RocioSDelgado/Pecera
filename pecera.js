...
const log = new Log("Rocio Delgado"); // Pon aquí tu nombre
...
class Pez {
    ...
    moverZigZag() {
        this.x += this.velocidad * this.direccionX;
        this.y += Math.sin(this.x * 0.1) * 3 * this.direccionY;
...
const peces = [
    ...
    new Pez("Laura", "img/pez2.png", 200, 150, "zigzag", log),
    new Pez("Tamara", "img/pez3.png", 300, 50, "burbujaCascada", log),
    new Pez("Tever", "img/pez4.png", 400, 200, "horizontal", log),
    new Pez("Caballito", "img/caballito.png", 250, 300, "zigzag", log),
];
